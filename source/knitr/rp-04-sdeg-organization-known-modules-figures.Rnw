...
%
% Program:  rp-04-gsea-organization-known-modules-figures.Rnw
% Version:  RPREP 1.0.1
...
%
%---------------------------------------------------------------------
<<rp_gene_set_radar_plots,out.width="0.95\\textwidth",fig.height=7,fig.width=14,fig.cap=paste('Radar Plot of enriched ',RadarLablGsea,'. Gene sets significantly enriched in at least two conditions are shown.  If there were more than 26 gene sets in the results, gene sets were further filtered to only include sets whose enrichment score was the top 26 of all sets(Ribosomal Profiling).',sep='')>>=
reportAssayFlag = 'ribosomal_profiling'
