...
#
# Program:  run-setup.sh
# Version:  RPREP 1.1.0
# Author:   Travis L. Jensen, Johannes B. Goll, Sami R. Cherikh, and William F. Hooper
# Purpose:  script to run program setup (parse configuration and download reference data)
# Input:    N/A
# Output:   N/A
#############################################################################################################
...
## dont forget to specify minimally "--config XXX" and "--log XXX" with this shell script command:
## for example: sh run-setup.sh --config case-study/config-dengue.xlsx --log run-setup.log
python3 $SRCDIR/python/rprep --setup $@