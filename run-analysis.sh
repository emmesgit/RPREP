...
# Purpose:  script to run the analysis steps of RPREP (generate statistical endpoints and larger intermediate files)
# Input:    N/A
# Output:   N/A
#############################################################################################################
...
## for example: sh run-analysis.sh --config case-study/config-dengue.xlsx --threads 32 --log run-analysis.log
